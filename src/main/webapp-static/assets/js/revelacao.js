...
(function () {
  ...
  function revelar(palcoInformado) {
    var palco = palcoInformado || document.getElementById('revelacao');
    if (!palco) return;
  ...
  // A pagina JSP recarrega a cada pacote aberto, entao basta o DOMContentLoaded.
  document.addEventListener('DOMContentLoaded', function () { revelar(); });

  // A vitrine estatica nao recarrega: ela troca o conteudo e precisa disparar a
  // revelacao na mao. Exportar daqui evita manter a mesma coreografia — stagger,
  // suspense da lendaria, movimento reduzido — escrita duas vezes.
  window.TheChampions = window.TheChampions || {};
  window.TheChampions.revelar = revelar;
})();
